...
const billSchema_1 = __importDefault(require("../../schemas/billSchema"));
class BillDao {
    static addBill(res, objBill) {
        return __awaiter(this, void 0, void 0, function* () {
            billSchema_1.default.create(objBill)
                .then((response) => {
    ...
    static getAll(res) {
        return __awaiter(this, void 0, void 0, function* () {
            billSchema_1.default.find().then((response) => {
